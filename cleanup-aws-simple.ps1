# Akazuba Florist AWS Cleanup Script (PowerShell) - Simple Version
param(
...
try {
    ...
    Write-Host "CloudFormation stack not found or already deleted" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "Frontend bucket not found or already deleted" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "Backend bucket not found or already deleted" -ForegroundColor Yellow
}
