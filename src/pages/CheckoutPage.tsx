            ...
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              ...
              <div className="border-t pt-4 space-y-3">
                ...
                <div className="border-t pt-3 flex justify-between text-xl font-bold text-gray-800">
                  <span>Total</span>
                  <span className="text-orange-500">RWF {calculateFinalTotal().toLocaleString()}</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full mt-6 bg-orange-500 text-white py-4 rounded-lg font-semibold hover:bg-orange-600 transition text-lg disabled:bg-gray-300 disabled:cursor-not-allowed"
              >
                Place Order
              </button>
            </div>
