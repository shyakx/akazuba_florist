...
const corsOptions = {
  origin: function (origin: string | undefined, callback: (err: Error | null, allow?: boolean) => void) {
    ...
    if (allowedOrigins.indexOf(origin) !== -1) {
      ...
      // Temporary fix: Allow akazubaflorist.com domains
      if (origin && (origin.includes('akazubaflorist.com') || origin.includes('vercel.app'))) {
        console.log('🔧 Temporary CORS fix: Allowing akazubaflorist.com domain')
        callback(null, true)
      } else {
